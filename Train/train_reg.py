...
def hyper_args():
    ...
    # RoadScene dataset
    parser.add_argument('--ir', default='../dataset/raw/ctrain/RoadScene/ir', type=pathlib.Path) # train: sigma=32 test: sigma=32
    parser.add_argument('--it', default='../dataset/raw/ctrain/RoadScene/it_edge', type=pathlib.Path)

    # M3FD dataset
    # parser.add_argument('--ir', default='../dataset/raw/ctrain/M3FD/ir', type=pathlib.Path) # train: sigma=32 test: sigma=32
