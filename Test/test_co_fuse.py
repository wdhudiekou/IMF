...
def hyper_args():
    ...
    # checkpoint
    parser.add_argument('--ckpt', default='../cache/Fusion_only/220525_fusion_svmsoft_ssim/fus_0200.pth', help='weight checkpoint', type=pathlib.Path) # weight/default.pth
    parser.add_argument('--dst', default='../results_Road/Fusion/220525_fusion_svmsoft_ssim/', help='fuse image save folder', type=pathlib.Path)
