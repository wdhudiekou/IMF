...
def hyper_args():
    ...
    # TNO dataset
    # parser.add_argument('--it', default='../dataset/raw/ctest/TNO/vi', type=pathlib.Path)
    # parser.add_argument('--ir', default='../dataset/raw/ctest/TNO/ir_warp', type=pathlib.Path)
    ...
    parser.add_argument('--ir',   default='../dataset/raw/ctest/Road/ir_warp',    type=pathlib.Path)
    ...
    # M3FD dataset
    # parser.add_argument('--it', default='../dataset/raw/ctest/M3FD/vi', type=pathlib.Path)
    ...
    # checkpoint
    parser.add_argument('--ckpt', default='../cache/Reg_only/Road/230720_pcnet_ir_it_edge/cp_0720.pth', help='weight checkpoint', type=pathlib.Path) # weight/default.pth
    parser.add_argument('--dst',  default='../results_Road/Reg/230720_pcnet_ir_it_edge/reg/', help='fuse image save folder', type=pathlib.Path)
